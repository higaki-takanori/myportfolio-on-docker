...
$(function () {
  ...
  var displayCount = $(".rule-form-list").length; // 見えているフォームの数を取得する
  ...
  $(".rule-form-list").on("click", ".delete-form-btn", function () {
    ...
    var lastIndex = $(".rule-form-list:last").data("index"); // フォームの最後に使われているインデックス番号を取得
...
/******/ });
//# sourceMappingURL=application-1113accfcd949e1bd716.js.map