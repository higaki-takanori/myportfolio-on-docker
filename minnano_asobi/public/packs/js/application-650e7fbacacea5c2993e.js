...
/* WEBPACK VAR INJECTION */(function($) {$(function () {
  ...
  $('.add-form-btn').on('click', function () {
    ...
    if (inputCount < maxCount) {
      ...
      var inputcontentName = element[0].querySelectorAll('input[name="rule[rule_content][content]"]');
      var inputimageName = element[0].querySelectorAll('input[name="rule[rule_content][image]"]');
      console.log(index);
      console.log(inputFile);
      console.log(inputcontentName[0].value);
      console.log(inputimageName[0].value);
...
/******/ });
//# sourceMappingURL=application-650e7fbacacea5c2993e.js.map