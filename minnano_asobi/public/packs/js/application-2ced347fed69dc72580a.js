...
/* WEBPACK VAR INJECTION */(function($) {//初回読み込み、リロード、ページ切り替えで動く。
$(document).on('turbolinks:load', function () {}); //初回読み込み、ページ切り替えで動く。リロードは動かない
...
/******/ });
//# sourceMappingURL=application-2ced347fed69dc72580a.js.map